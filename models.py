...
class Car(Base):
    ...
    category: Mapped[str] = mapped_column(String(16), unique=True)
    marka: Mapped[str] = mapped_column(String(16), unique=True)
    model: Mapped[str] = mapped_column(String(16), unique=True)
